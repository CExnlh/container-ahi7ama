...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ahi7ama.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ahi7ama.containers.anotherwebservice.com/
...
```
git clone git@github.com:CExnlh/container-ahi7ama.git
cd container-ahi7ama
```
...
```
docker attach container-ahi7ama
```
